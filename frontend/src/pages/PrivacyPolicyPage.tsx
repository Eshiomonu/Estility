...
import { usePrivacyPolicy, PrivacyContentBlock } from "../hooks/usePrivacyPolicy";
import { PortableText, PortableTextComponents } from "@portabletext/react";
import { PortableTextBlock } from "@portabletext/types";

// Convert privacy content to PortableText blocks
function formatPrivacyContent(blocks: PrivacyContentBlock[] | undefined): PortableTextBlock[] {
  if (!blocks) return [];
...
export default function PrivacyPolicyPage() {
  ...
  const { data: contentData, loading: contentLoading, error: contentError } = usePrivacyPolicy();
