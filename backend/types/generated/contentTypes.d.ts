...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta_button: Schema.Attribute.Component<'navigation.cta-button', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    story_description: Schema.Attribute.RichText;
...
export interface ApiCookiesPolicyCookiesPolicy
  extends Struct.CollectionTypeSchema {
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answers: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    company_links: Schema.Attribute.Component<'footer.footer-link', true>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    social_links: Schema.Attribute.Component<'footer.social-link', true>;
    support_links: Schema.Attribute.Component<'footer.support-links', true>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Appstore: Schema.Attribute.Component<'hero.appstore', true>;
    carousel_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hero.hero'> &
      Schema.Attribute.Private;
    Playstore: Schema.Attribute.Component<'hero.playstore', true>;
    publishedAt: Schema.Attribute.DateTime;
    Testifier_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    testifier_text: Schema.Attribute.String;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHowItWorkHowItWork extends Struct.SingleTypeSchema {
  ...
  attributes: {
    buttons: Schema.Attribute.Component<'how-it-works.buttons', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'navigation.cta-button', true>;
    description: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta_button: Schema.Attribute.Component<'navigation.cta-button', false>;
...
export interface ApiPageTitlePageTitle extends Struct.CollectionTypeSchema {
...
export interface ApiPartnerSectionPartnerSection
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    partner_cards: Schema.Attribute.Component<'partner.partner-card', true>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTopVendorTopVendor extends Struct.CollectionTypeSchema {
  collectionName: 'top_vendors';
  info: {
    displayName: 'TopVendor';
    pluralName: 'top-vendors';
    singularName: 'top-vendor';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiWhoBuiltForWhoBuiltFor extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Who Built For';
    pluralName: 'who-built-fors';
    singularName: 'who-built-for';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    cards: Schema.Attribute.Component<'who-is-built-for.card', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::who-built-for.who-built-for'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiWhyEstilityWhyEstility extends Struct.SingleTypeSchema {
  collectionName: 'why_estilities';
  info: {
    displayName: 'Why Estility';
    pluralName: 'why-estilities';
    singularName: 'why-estility';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    cards: Schema.Attribute.Component<'why-estility.why-estility-card', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Blocks;
